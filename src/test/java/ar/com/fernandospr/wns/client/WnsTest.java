...
public class WnsTest extends TestCase {
    ...
    public void testXmlSerialization() {
        ...
        verify(postRequestedFor(urlEqualTo("/fakechannel"))
                .withRequestBody(equalToXml("<toast><type>wns/toast</type><visual><binding template=\"ToastText02\"><image/><text id=\"1\">a</text><text id=\"2\">b</text></binding></visual><audio/></toast>")));
    }
}
